...
docker run --name mysql-container1 -d -e MYSQL_ROOT_PASSWORD=secret-password -p 3306:3306 mysql:latest
...
docker run --name mysql-container2 -d -e MYSQL_ROOT_PASSWORD=secret-password -p 3307:3306 mysql:latest
